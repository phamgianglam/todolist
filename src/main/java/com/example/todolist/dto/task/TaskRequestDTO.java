...
public record TaskRequestDTO(
    ...
    @NotNull @Schema(example = "PENDING") Status status,
    @Pattern(
            regexp =
                "^\\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])T([01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d(Z|[+-]\\d{2}:[0-5]\\d)?$",
            message =
                "dueDate must be in ISO 8601 format (e.g., '2023-05-20T10:15:30Z' or '2023-05-20T10:15:30+01:00')")
        @NotNull
